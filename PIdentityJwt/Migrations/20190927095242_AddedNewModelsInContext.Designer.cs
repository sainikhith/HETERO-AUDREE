...
namespace PIdentityJwt.Migrations
{
    ...
    [Migration("20190927095242_AddedNewModelsInContext")]
    partial class AddedNewModelsInContext
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PIdentityJwt.Models.FunctionItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<int>("UsersInRolesId");

                    b.HasKey("Id");

                    b.HasIndex("UsersInRolesId");

                    b.ToTable("FunctionItems");
                });
            ...
            modelBuilder.Entity("PIdentityJwt.Models.FunctionItem", b =>
                {
                    b.HasOne("PIdentityJwt.Models.UsersInRoles", "UsersInRoles")
                        .WithMany()
                        .HasForeignKey("UsersInRolesId")
